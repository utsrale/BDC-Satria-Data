...
# Sel 6: Augmentasi Citra (288x288)
cells.append({
    "cell_type": "code",
    "execution_count": None,
    "metadata": {},
...
# Sel 7: Fungsi Epoch & Validasi (Bersih Tanpa tqdm spam)
cells.append({
    "cell_type": "code",
    "execution_count": None,
    "metadata": {},
...
# Sel 8: Helper Function untuk Training K-Fold Arsitektur apa pun (5-Fold, 10-Epoch)
cells.append({
    "cell_type": "code",
    "execution_count": None,
    "metadata": {},
    ...
    "source": [
        ...
        "            \n",
        "            # --- STAGE 1: Freeze Backbone & Hanya Latih Classifier Head (Epoch 1-3) ---\n",
        ...
        "                # --- TRANSISI KE STAGE 2: Unfreeze Backbone (Mulai Epoch 4 / Indeks 3) ---\n",
        "                if epoch == 3 and not is_stage_2:\n",
        "                    write_log(\"  [Stage Transition] Epoch 4: Unfreeze seluruh backbone dengan LR = 1e-5\")\n",
        ...
        "                \n",
        "                stage_name = \"Stage 2\" if is_stage_2 else \"Stage 1\"\n",
        "                msg = (f'Epoch {epoch+1}/{num_epochs} ({stage_name}) | '\n",
...
# Sel 9: Training 2 Arsitektur Bergantian (ConvNeXt & EfficientNet)
cells.append({
    "cell_type": "code",
    "execution_count": None,
    "metadata": {},
...
# Sel 10: Ensemble & Koreksi ID String murni
cells.append({
    "cell_type": "code",
    "execution_count": None,
    "metadata": {},
...
print("Notebook Simple & Advanced 5-Fold 10-Epoch sukses dibangun!")
